...
class ProductUsecase:
    ...
    async def create(self, body: ProductIn) -> ProductOut:
        ...
        try:
            ...
            raise InsertionException(message="Já existe um produto com esse identificador.")
        except PyMongoError as e:
            raise InsertionException(message=f"Erro ao inserir produto: {str(e)}")
    ...
    async def update(self, id: UUID, body: ProductUpdate) -> ProductUpdateOut:
        ...
        # Se updated_at não foi fornecido, define automaticamente
